...
public sealed class Loc : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["UiLangToggle"] = "🌐 Magyar",
        ["UpdateBtn"] = "⬆ Update",
        ["UpdateTip"] = "Check for a newer version",
        ["RunBtn"] = "▶ Start review",
        ["StopBtn"] = "■ Stop",
        // Update flow
        ["StUpdChecking"] = "Checking for updates…",
        ["StUpdNone"] = "You are on the latest version (v{0}).",
        ["StUpdDevBuild"] = "Updates are only available in the installed app.",
    ...
    private static readonly Dictionary<string, string> Hu = new()
    {
        ...
        ["UpdateBtn"] = "⬆ Frissítés",
        ["UpdateTip"] = "Újabb verzió keresése",
        ["RunBtn"] = "▶ Review indítása",
        ["StopBtn"] = "■ Stop",
        ["StUpdChecking"] = "Frissítés keresése…",
        ["StUpdNone"] = "A legújabb verziót használod (v{0}).",
        ["StUpdDevBuild"] = "A frissítés csak a telepített alkalmazásban érhető el.",
